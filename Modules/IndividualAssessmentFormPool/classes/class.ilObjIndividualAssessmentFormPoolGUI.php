...
/**
 * @ilCtrl_Calls ilObjIndividualAssessmentFormPoolGUI: ilPermissionGUI
 * @ilCtrl_Calls ilObjIndividualAssessmentFormPoolGUI: ilInfoScreenGUI
 * @ilCtrl_Calls ilObjIndividualAssessmentFormPoolGUI: ilObjectCopyGUI
 * @ilCtrl_Calls ilObjIndividualAssessmentFormPoolGUI: ilCommonActionDispatcherGUI
 * @ilCtrl_Calls ilObjIndividualAssessmentFormPoolGUI: ilExportGUI
 * @ilCtrl_Calls ilObjIndividualAssessmentFormPoolGUI: IAFPFormsGUI, IAFPFieldsGUI
 */
class ilObjIndividualAssessmentFormPoolGUI extends ilObjectGUI
{
    ...
    public const TAB_FORMS = 'tab_forms';
    public const TAB_FIELDS = 'tab_fields';
