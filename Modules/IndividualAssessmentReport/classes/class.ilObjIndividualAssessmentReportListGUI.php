...
class ilObjIndividualAssessmentReportListGUI extends ilObjectListGUI
{
    public function init(): void
    {
        ...
        $this->type = "iarp";
        $this->gui_class_name = "ilObjIndividualAssessmentReportGUI";

        // general commands array
        $this->commands = ilObjIndividualAssessmentReportAccess::_getCommands();
    }
