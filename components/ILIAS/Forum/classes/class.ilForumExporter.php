...
class ilForumExporter extends ilXmlExporter implements ilForumObjectConstants
{
    ...
    public function getValidSchemaVersions(string $a_entity): array
    {
        return [
            "4.1.0" => [
                "namespace" => "http://www.ilias.de/components/ILIAS/Forum/frm/4_1",
            ...
            "4.5.0" => [
                "namespace" => "http://www.ilias.de/components/ILIAS/Forum/frm/4_5",
            ...
            "5.1.0" => [
                "namespace" => "http://www.ilias.de/components/ILIAS/Forum/frm/5_1",
            ...
            "8.0" => [
                "namespace" => "http://www.ilias.de/components/ILIAS/Forum/frm/8",
            ...
            "9.0" => [
                "namespace" => "http://www.ilias.de/components/ILIAS/Forum/frm/9",
