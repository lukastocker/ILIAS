...
class ReaderTest extends TestCase
{
    ...
    public function testImplementWithSimpleImplementation(): void
    {
        ...
        $implement = new D\Out(D\OutType::IMPLEMENT, $name, ImplementsTestInterface::class, []);
    ...
    public function testImplementWithElaborateImplementation(): void
    {
        ...
        $internal = new D\In(D\InType::INTERNAL, "something");
        $implement = new D\Out(D\OutType::IMPLEMENT, $name, ImplementsTestInterface::class, [$use, $seek, $pull, $internal]);
        ...
        $this->assertEquals([$internal], $result[(string) $internal]);
    }
    ...
    public function testImplementWithTwoImplementations(): void
    {
        ...
        $name = TestInterface::class;
        $implement = new D\Out(D\OutType::IMPLEMENT, $name, "ILIAS\\Core\\Tests\\Dependencies\\ImplementsTestInterface", []);
        $implement2 = new D\Out(D\OutType::IMPLEMENT, $name, "ILIAS\\Core\\Tests\\Dependencies\\Implements2TestInterface", []);
    ...
    public function testContributeWithSimpleImplementation(): void
    {
        ...
        $name = TestInterface::class;
        $contribute = new D\Out(D\OutType::CONTRIBUTE, $name, ImplementsTestInterface::class, []);
    ...
    public function testContributeWithElaborateImplementation(): void
    {
        ...
        $pull = new D\In(D\InType::PULL, $name);
        $internal = new D\In(D\InType::INTERNAL, "something");
        $contribute = new D\Out(D\OutType::CONTRIBUTE, $name, ImplementsTestInterface::class, [$use, $seek, $pull, $internal]);
    ...
    public function testProvideWithSimpleImplementation(): void
    {
        ...
        $name = TestInterface::class;
        $provide = new D\Out(D\OutType::PROVIDE, $name, ImplementsTestInterface::class, []);
    ...
    public function testProvideWithElaborateImplementation(): void
    {
        ...
        $pull = new D\In(D\InType::PULL, $name);
        $internal = new D\In(D\InType::INTERNAL, "something");
        $provide = new D\Out(D\OutType::PROVIDE, $name, ImplementsTestInterface::class, [$use, $seek, $pull, $internal]);
