...
class Reader
{
    ...
    protected function addImplement(int $i, string $name, $value)
    {
        ...
        $d = new Out(OutType::IMPLEMENT, $name, get_class($impl), $dependencies);
        $this->implements[$i] = $d;
    }
    ...
    protected function addContribute(int $i, string $name, $value)
    {
        ...
        $d = new Out(OutType::CONTRIBUTE, $name, get_class($impl), $dependencies);
    ...
    protected function addProvide(int $i, string $name, $value)
    {
        ...
        $d = new Out(OutType::PROVIDE, $name, get_class($impl), $dependencies);
        $this->provides[$i] = $d;
    }
