...
class ilExerciseExporter extends ilXmlExporter
{
    ...
    public function getValidSchemaVersions(string $a_entity): array
    {
        return array(
            "4.1.0" => array(
                "namespace" => "https://www.ilias.de/components/ILIAS/Exercise/exc/4_1",
                "xsd_file" => "ilias_exc_4_1.xsd",
                "uses_dataset" => true,
                "min" => "4.1.0",
                "max" => "4.3.99"),
            "4.4.0" => array(
                "namespace" => "https://www.ilias.de/components/ILIAS/Exercise/exc/4_4",
                "xsd_file" => "ilias_exc_4_4.xsd",
                "uses_dataset" => true,
                "min" => "4.4.0",
                "max" => "4.4.99"),
            "5.0.0" => array(
                "namespace" => "https://www.ilias.de/components/ILIAS/Exercise/exc/5_0",
                "xsd_file" => "ilias_exc_5_0.xsd",
                "uses_dataset" => true,
                "min" => "5.0.0",
                "max" => "5.0.99"),
            "5.1.0" => array(
                "namespace" => "https://www.ilias.de/components/ILIAS/Exercise/exc/5_1",
                "xsd_file" => "ilias_exc_5_1.xsd",
                "uses_dataset" => true,
                "min" => "5.1.0",
                "max" => "5.1.99"),
            "5.2.0" => array(
                "namespace" => "https://www.ilias.de/components/ILIAS/Exercise/exc/5_2",
                "xsd_file" => "ilias_exc_5_2.xsd",
                "uses_dataset" => true,
                "min" => "5.2.0",
                "max" => "5.2.99"),
            "5.3.0" => array(
                "namespace" => "https://www.ilias.de/components/ILIAS/Exercise/exc/5_3",
